...
from core.apis.assignments import student_assignments_resources, teachers_assignment_resources
...
app.register_blueprint(teachers_assignment_resources, url_prefix='/teacher')
